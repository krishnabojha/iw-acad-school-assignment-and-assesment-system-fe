...
export default class SMaterialBlock extends Component {
    ...
    async componentDidMount() {
        try {
            ...
            const res = await fetch('http://serene-wave-21722.herokuapp.com/data/studymaterial_material_list/'+this.props['classid']); // fetching the data from api, before the page loaded
